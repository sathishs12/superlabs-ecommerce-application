     ...
     switch (section) {
       ...
       case "price":
         ...
         result = result.filter((p) => {
           ...
           if (priceFilter.from25to50)
             checks.push(price >= 2000 && price <= 4000);
           if (priceFilter.from50to100)
             checks.push(price > 4000 && price <= 8000);
   ...
   <Box sx={{ pt: { xs: "170px", md: "180px" }, pb: "100px" }}>
     <Box
       sx={{
         ...
         transform: showMobileFilter
           ? "translateY(0)"
           : `translateY(-${mobileFilterHeight}px)`,
       }}
     >
     ...
     <Grid
       container
       spacing={{ xs: 2, md: 3 }}
       sx={{ px: { xs: 1, sm: 2, md: 2 }, py: { xs: 1, sm: 2, md: 3 } }}
     >
       <Grid
         item
         xs={0}
